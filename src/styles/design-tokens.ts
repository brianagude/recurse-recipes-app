...
export const buttons = {
  ...
  tag: `${typography.b2} px-4 py-1.5 rounded-full border-2 border-black hover:bg-gray-light`,
  tagIcon: `${typography.b2} flex items-center gap-3 pr-4 pl-3 py-1.5 gap-2 rounded-full border-2 border-black hover:bg-gray-light`,
